...
export default function TrackList({
  ...
  const pathologyTags = [
    { text: 'ACUTE NOSTALGIA', color: 'bg-poster-orange text-white border-black' },
    { text: '3AM SPIRALING', color: 'bg-poster-pink text-white border-black' },
    { text: 'HEAVY COPING', color: 'bg-cyan-400 text-black border-black' },
    { text: 'DISSOCIATION', color: 'bg-poster-purple text-white border-black' },
    { text: 'MAIN CHARACTER', color: 'bg-poster-green text-black border-black' },
    { text: 'INDIE HYPOCRISY', color: 'bg-amber-300 text-black border-black' },
  ];

  return (
    <div className="min-h-screen bg-poster-blue text-white font-body selection:bg-poster-pink selection:text-white pb-32 relative">
      
      {/* 1. TOP NAVBAR (Midnight Dark with Lime Border) */}
      <header className="sticky top-0 z-40 bg-poster-dark border-b-4 border-poster-green px-4 sm:px-8 py-3.5 shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2 border-2 border-black px-2.5 py-1 font-mono text-[11px] bg-poster-purple text-white font-bold shadow-brutal-sm">
          ...
          <div className="flex items-center gap-4">
            {user && (
              <div className="hidden md:flex items-center gap-2 border-2 border-black px-3 py-1 font-mono text-xs bg-poster-dark text-white shadow-brutal-sm">
                <span className="text-zinc-400 font-bold">PATIENT:</span>
                <span className="font-headline text-sm uppercase text-poster-green">{user.display_name}</span>
              </div>
            )}
            <button
              onClick={onLogout}
              className="inline-flex items-center gap-1.5 px-4 py-1.5 border-2 border-black bg-white hover:bg-poster-pink hover:text-white text-black font-mono text-xs font-bold uppercase tracking-wider transition-all shadow-brutal-sm hover:translate-x-0.5 hover:translate-y-0.5"
            >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 pt-10 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <div className="border-4 border-black bg-white text-black p-5 shadow-brutal-lg">
              
              <div className="flex items-center justify-between border-b-3 border-black pb-3 mb-3">
                <div className="flex items-center gap-2 font-mono text-xs font-bold uppercase tracking-wider">
                  <Activity className="w-4 h-4 text-poster-pink" />
              ...
              <div className="w-full h-64 bg-zinc-950 border-3 border-black relative overflow-hidden shadow-inner">
                ...
                <div className="absolute top-2 left-3 font-mono text-[10px] font-bold text-black bg-poster-green px-2 py-0.5 border border-black shadow-brutal-sm">
                  FREQ: {((stats?.avgTempo || 120) * 18.2).toFixed(1)}Hz // 3D TERRAIN
                </div>
                <div className="absolute top-2 right-3 font-mono text-[10px] font-bold text-white bg-poster-pink px-2 py-0.5 border border-black shadow-brutal-sm">
                  ENERGY: {stats?.avgEnergy}%
                </div>
                <div className="absolute bottom-2 left-3 font-mono text-[10px] font-bold text-black bg-cyan-300 px-2 py-0.5 border border-black shadow-brutal-sm">
                  CH: STEREO PHASE MATRIX
                </div>
                <div className="absolute bottom-2 right-3 font-mono text-[10px] font-bold text-black bg-poster-green px-2 py-0.5 border border-black shadow-brutal-sm">
                  VALENCE: {stats?.avgValence}%
                </div>
              </div>

              <div className="mt-3 font-mono text-[11px] text-zinc-800 font-bold flex justify-between">
                <span className="flex items-center gap-1 text-poster-purple">
            ...
            {stats && (
              <div className="border-4 border-black bg-poster-purple text-white p-5 sm:p-6 shadow-brutal-lg">
                <div className="flex items-center justify-between border-b-3 border-black pb-2 mb-4 font-mono text-xs font-bold uppercase tracking-wider">
                  <div className="flex items-center gap-1.5">
                    <BarChart3 className="w-4 h-4 text-poster-green" />
                    <span>VITAL SIGNS & ACOUSTIC TELEMETRY</span>
                  </div>
                  <span className="bg-poster-green border-2 border-black text-black text-[10px] font-bold px-2 py-0.5 shadow-brutal-sm">
                    LAB DNA
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  ...
                  <div className="border-3 border-black p-3.5 bg-cyan-400 text-black shadow-brutal-sm hover:-translate-y-0.5 transition-transform">
                  ...
                  <div className="border-3 border-black p-3.5 bg-poster-green text-black shadow-brutal-sm hover:-translate-y-0.5 transition-transform">
                    <div className="flex justify-between items-end mb-1">
                  ...
                  <div className="border-3 border-black p-3.5 bg-poster-orange text-white shadow-brutal-sm hover:-translate-y-0.5 transition-transform">
                    <div className="flex justify-between items-end mb-1">
                  ...
                  <div className="border-3 border-black p-3.5 bg-poster-pink text-white shadow-brutal-sm hover:-translate-y-0.5 transition-transform">
                    <div className="flex justify-between items-end mb-1">
                    ...
                    <div className="w-full h-3.5 bg-white border-2 border-black overflow-hidden flex">
                      <div
                        className="h-full bg-poster-green transition-all duration-700"
                ...
                <div className="mt-4 pt-3 border-t-2 border-dashed border-white/30 flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2 font-mono text-xs">
                    ...
                    <span className="bg-poster-green border-2 border-black text-black px-2.5 py-0.5 font-headline text-sm uppercase shadow-brutal-sm">
                      {stats.dominantGenre || 'Indie / Alt'}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 font-mono text-xs">
                    <span className="font-bold text-white/80 uppercase">MAINSTREAM SCORE:</span>
                    <span className="bg-poster-orange text-white border-2 border-black px-2.5 py-0.5 font-headline text-sm uppercase shadow-brutal-sm">
                      {stats.avgPopularity}%
                    </span>
                  </div>
                </div>
            ...
            <div className="border-4 border-black bg-white text-black p-5 shadow-brutal-lg">
              <div className="flex items-center justify-between border-b-3 border-black pb-3 mb-3">
                ...
                <span className="font-mono text-xs bg-poster-green border border-black px-2 py-0.5 font-bold uppercase">
              ...
              <div className="flex flex-col divide-y-2 divide-zinc-200 max-h-[440px] overflow-y-auto pr-1">
                {tracks.map((track, idx) => {
                  ...
                  return (
                    <div
                      key={track.id || idx}
                      className="group flex items-center justify-between py-2.5 hover:bg-poster-green/20 px-2 transition-colors"
                    >
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        {track.external_urls?.spotify && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="border-2 border-black p-1 bg-white hover:bg-poster-green text-black transition-colors shadow-brutal-sm"
        ...
        {roastData && (
          <section id="poster-section" className="mt-16 pt-12 border-t-6 border-black">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div>
                <div className="border-3 border-black bg-poster-pink text-white px-3 py-1 font-mono text-xs font-bold uppercase tracking-wider inline-block mb-2 shadow-brutal">
              ...
              <span className="font-mono text-xs bg-poster-green border-2 border-black px-3 py-1 text-black font-bold uppercase shadow-brutal">
                1080x1920 (9:16 STORY)
              </span>
            </div>

            <div className="border-4 border-black bg-white p-6 sm:p-8 shadow-brutal-lg text-black">
              <PosterCanvas
                user={user}
                tracks={tracks}
                stats={stats}
